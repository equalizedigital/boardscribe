...
<table class="form-table" role="presentation">
	<tbody>
		<tr>
			<th scope="row">
				<label for="edmm_meeting_date"><?php esc_html_e( 'Meeting Date', 'equalize-digital-meeting-minutes' ); ?> <span aria-hidden="true">*</span></label>
			</th>
			<td>
				<input
					type="date"
					...
					class="regular-text"
				/>
				<p class="description"><?php esc_html_e( 'Required. Format: YYYY-MM-DD', 'equalize-digital-meeting-minutes' ); ?></p>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="edmm_meeting_agenda_url"><?php esc_html_e( 'Agenda URL', 'equalize-digital-meeting-minutes' ); ?></label>
			</th>
			<td>
				<input
					type="url"
				...
				<button
					...
					data-title="<?php esc_attr_e( 'Choose Agenda File', 'equalize-digital-meeting-minutes' ); ?>"
					data-insert="<?php esc_attr_e( 'Use this file', 'equalize-digital-meeting-minutes' ); ?>"
				><?php esc_html_e( 'Media Library', 'equalize-digital-meeting-minutes' ); ?></button>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="edmm_meeting_minutes_url"><?php esc_html_e( 'Minutes URL', 'equalize-digital-meeting-minutes' ); ?></label>
			</th>
			<td>
				<input
					type="url"
				...
				<button
					...
					data-title="<?php esc_attr_e( 'Choose Minutes File', 'equalize-digital-meeting-minutes' ); ?>"
					data-insert="<?php esc_attr_e( 'Use this file', 'equalize-digital-meeting-minutes' ); ?>"
				><?php esc_html_e( 'Media Library', 'equalize-digital-meeting-minutes' ); ?></button>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Meeting Not Held', 'equalize-digital-meeting-minutes' ); ?>
			</th>
			<td>
				<label for="edmm_meeting_not_held">
					...
					/>
					<?php esc_html_e( 'This meeting was not held', 'equalize-digital-meeting-minutes' ); ?>
				</label>
			</td>
		</tr>
		<?php
