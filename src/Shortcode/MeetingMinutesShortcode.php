...
class MeetingMinutesShortcode {
	...
	public function render( array $atts ): string {
		...
		$instance_config = [
			...
			'hideNotes'         => filter_var( $atts['hide_notes'], FILTER_VALIDATE_BOOLEAN ),
			...
			'notesLabel'        => sanitize_text_field( $atts['notes_label'] ),
			'agendaLinkLabel'   => sanitize_text_field( $atts['agenda_link_label'] ),
			'notesLinkLabel'    => sanitize_text_field( $atts['notes_link_label'] ),
