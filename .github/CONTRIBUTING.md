...
To receive free support for BoardScribe we have the following channels:
* [The support pages on our site](https://equalizedigital.com/contact/)
* [Support forums](https://wordpress.org/support/plugin/boardscribe/) on WordPress.org
...
* update to the newest versions of WordPress and the BoardScribe plugin.
...
Make sure your problem does not exist as a ticket already by searching through [the existing issues](https://github.com/equalizedigital/boardscribe/issues). If you cannot find anything which resembles your problem, please [create a new issue](https://github.com/equalizedigital/boardscribe/issues/new).
