		...
		return array_merge(
			[
				[
					...
					'type'        => self::TYPE_TEXT,
					'group'       => 'general',
					'label'       => __( 'Included Years', 'equalize-digital-meeting-minutes' ),
					'default'     => '',
					'placeholder' => '2023,2024',
					'description' => __( 'Comma-separated list of years. Leave blank to show all years.', 'equalize-digital-meeting-minutes' ),
					'rest_arg'    => true,
				],
				[
					'key'      => 'posts_per_page',
					...
					'group'    => 'general',
					'label'    => __( 'Posts Per Page', 'equalize-digital-meeting-minutes' ),
					'default'  => 20,
					'rest_arg' => true,
				],
				[
					...
					'type'              => self::TYPE_TEXT,
					'group'             => 'general',
					'label'             => __( 'Held Date Format', 'equalize-digital-meeting-minutes' ),
					'default'           => 'Y/m/d',
					'description'       => __( 'PHP date() format. See php.net/manual/en/datetime.format.php for the full reference.', 'equalize-digital-meeting-minutes' ),
				...
				[
					...
					'type'              => self::TYPE_TEXT,
					'group'             => 'general',
					'label'             => __( 'Not Held Date Format', 'equalize-digital-meeting-minutes' ),
					'default'           => 'Y/m',
					'sanitize_callback' => static function ( $value ) {
				...
				[
					...
					'group'   => 'general',
					'label'   => __( 'Display Template', 'equalize-digital-meeting-minutes' ),
					'default' => '',
					'choices' => [
						''              => __( 'Table (default)', 'equalize-digital-meeting-minutes' ),
						'year-timeline' => __( 'Timeline (grouped by year)', 'equalize-digital-meeting-minutes' ),
					],
				],
				[
					'key'         => 'equal_columns',
					...
					'group'       => 'general',
					'label'       => __( 'Force all columns to the same width', 'equalize-digital-meeting-minutes' ),
					'default'     => false,
					'description' => __( 'Helps align columns consistently for vertical rhythm across rows.', 'equalize-digital-meeting-minutes' ),
				],
				[
					'key'                 => 'class',
					'type'                => self::TYPE_TEXT,
					'group'               => 'general',
					'label'               => __( 'Custom CSS Class', 'equalize-digital-meeting-minutes' ),
					'default'             => '',
				...
				[
					...
					'type'    => self::TYPE_TEXT,
					'group'   => 'column_labels',
					'label'   => __( 'Title', 'equalize-digital-meeting-minutes' ),
					'default' => '',
				],
				[
					'key'     => 'date_label',
					'type'    => self::TYPE_TEXT,
					'group'   => 'column_labels',
					'label'   => __( 'Date', 'equalize-digital-meeting-minutes' ),
					'default' => '',
				],
				[
					'key'     => 'agenda_label',
					'type'    => self::TYPE_TEXT,
					'group'   => 'column_labels',
					'label'   => __( 'Agenda', 'equalize-digital-meeting-minutes' ),
					'default' => '',
				],
				[
					'key'     => 'minutes_label',
					'type'    => self::TYPE_TEXT,
					'group'   => 'column_labels',
					'label'   => __( 'Minutes', 'equalize-digital-meeting-minutes' ),
					'default' => '',
				],
				[
					...
					'type'     => self::TYPE_TEXT,
					'group'    => 'link_labels',
					'label'    => __( 'Agenda Link Label', 'equalize-digital-meeting-minutes' ),
					'default'  => '',
					'rest_arg' => true,
				],
				[
					...
					'type'     => self::TYPE_TEXT,
					'group'    => 'link_labels',
					'label'    => __( 'Minutes Link Label', 'equalize-digital-meeting-minutes' ),
					'default'  => '',
					'rest_arg' => true,
				],
				[
