...
class SettingsPage {
	...
	public function add_submenu_page(): void {
		add_submenu_page(
			...
			__( 'Meeting Minutes Settings', 'equalize-digital-meeting-minutes' ),
			__( 'Settings', 'equalize-digital-meeting-minutes' ),
			'manage_options',
			'edmm-settings',
			[ $this, 'render_page' ]
		);
	...
	public function register_settings(): void {
		...
		add_settings_section(
			...
			__( 'Advanced', 'equalize-digital-meeting-minutes' ),
		...
		add_settings_field(
			'delete_on_uninstall',
			__( 'Delete Data on Uninstall', 'equalize-digital-meeting-minutes' ),
...
JS;
			...
			case FieldRegistry::TYPE_NUMBER_WITH_ALL:
				...
				<label style="margin-left:8px;">
					<input
						...
						<?php checked( $is_all ); ?>
					/>
					<?php esc_html_e( 'Show all', 'equalize-digital-meeting-minutes' ); ?>
				</label>
				<input
					type="hidden"
	...
	public function render_delete_on_uninstall(): void {
		...
		<label for="edmm_delete_on_uninstall">
			...
			/>
			<?php esc_html_e( 'Remove all meeting minutes posts and plugin settings when this plugin is deleted.', 'equalize-digital-meeting-minutes' ); ?>
		</label>
		<p class="description" style="color:#d63638;"><?php esc_html_e( 'Warning: this cannot be undone.', 'equalize-digital-meeting-minutes' ); ?></p>
		<?php
	}
